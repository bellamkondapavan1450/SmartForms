...
public class InboxFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getReference().child("Users").child(auth.getCurrentUser().getUid()).child("Inbox");
            ...
            protected void onBindViewHolder(@NonNull MailItemViewHolder holder, int position, @NonNull MailItem model) {
                ...
                holder.setMailItemClickListener(new MailItemClickListener() {
                    ...
                    public void onProfileClick(View view, int position) {
                        firebaseDatabase.getReference().child("Users").child(model.getSenderUid()).child("Details").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                User user = snapshot.getValue(User.class);
                                if (user != null) {
                                    Picasso.get().load(user.getImage()).placeholder(R.drawable.profilebg).into(imageView);
